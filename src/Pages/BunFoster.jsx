...
import bunFosterImage from "../assets/bun-foster-picture.jpg";

import FosterPageBody from "../components/FosterPageBody";

import rabbitFoster1 from "../assets/rabbit-foster-photos/rabbit-foster1.jpg";
import rabbitFoster2 from "../assets/rabbit-foster-photos/rabbit-foster2.jpg";
import rabbitFoster3 from "../assets/rabbit-foster-photos/rabbit-foster3.jpg";

export default function BunFoster() {
  ...
  return (
    <FosterPageBody
      mainBlurb={`Fostering a rabbit is a rewarding experience that takes dedication and love. Our foster carers receive plenty of support and advice as they join our great community striving for the same goal. No prior experience is needed to become a foster carer, just a home and love to give. Join us today!`}
      applicationLink={""}
      onboardingLink={""}
      mainImage={bunFosterImage}
      mainImageAlt={""}
      infoBody={
        <>
          <FosterParagraph
            heading={
              "What you will need NOTE WE NEED TO FILL THIS OUT WE DO NOT KNOW ABOUT BUNNIES LMAO XD"
            }
          ...
          - Bedding
          - Carrier
          - Animal crate / play-pen 
          
          As we are a non-for-profit, we rely on donations. While we can support fosters with food and litter this depends on the availability of our supplies, as such we ask fosters to provide the essential and to reach out if they need assistance.`}
            iconSvg={
              <svg
                fill="#644765"
                height="100%"
          ...
          <FosterParagraph
            ...
            body={
              <p>
                All foster rabbits will need to be quarantined from existing
                household pets, unless specified differently. This is for a
                period of 14 days as the rabbit is coming straight from a pound
                we must ensure the health and safety of them and your current
                pets. A reccomended way to isolate is using a bathroom, laundry
                or spare room, where your foster can be completely separated for
                the isolation period. Isolation reduces the chance of disease or
                illnesses spreading, as symptoms may appear during this period
                allowing us to treat effectively. This also allows any treatment
                given on intake to do it's thing (flea and worm treatment, first
                vaccination)
              </p>
            }
            iconSvg={
              ...
              body={
                <>
                  <p className="text-md  whitespace-pre-line font-light lg:pr-0 xl:mb-6 xl:text-xl">
                    {`Access to transportation is vital as your foster will need to be picked up from us, and also may need to see a vet during your foster journey, it is also extremely important in the case of an emergency. Having access to a car is ideal, however certainly not a deal-breaker as we have a dedicated team of transport volunteers always ready to help.`}
                  </p>
                  <p
                    ref={vetListRef}
                    className="text-md scroll-m-16  whitespace-pre-line pr-10 font-light lg:pr-0 xl:mb-6 xl:text-xl"
                  >
          ...
          <FosterParagraph
            ...
            body={
              <p className="text-md  whitespace-pre-line  font-light lg:pr-0 xl:mb-6 xl:text-xl">
                Upon the arrival of your first foster bun, you will be invited
                ...
                pictures of your rabbits with the rest of the group and provide
            ...
            body={
              <>
                <p className="text-md  whitespace-pre-line  font-light lg:pr-0 xl:mb-6 xl:text-xl">
                  ...
                  update on your foster rabbit. Ideally, this includes an
                  updated picture and written update on how the rabbit is going
                  in your care, any changes in temperament, how it’s getting
                  along with other pets in your household, how it’s getting
                  along with you and your other family members etc.{" "}
                </p>{" "}
                <p>
                  {" "}
                  The weekly check-in isn’t only for the rabbit's welfare, it is
                  also a welfare check on you! Sometimes foster caring can be
                  tough, we know that. You can try and try and a rabbit can just
                  ...
                  rabbit. If you forget to reach out to us at least once per
                  week, don’t worry – you’ll find a Strong Hearts Coordinator
                  will be in touch with you anyway to touch base.
                </p>
              </>
            }
            iconSvg={
          ...
          <FosterParagraph
            ...
            body={
              <div className="flex flex-col gap-2 pl-2 md:pl-8 [&>h1]:font-semibold">
                ...
                <p className="text-md font-light lg:pr-0 xl:mb-6 xl:text-xl">
                  While the bun is in your care, we ask that you keep us updated
                  with regular pictures and videos. Look for photo opportunities
                  when possible. A good photo is the difference between bun
                  staying in care for weeks. Photos with good lighting that
                  really capture the cuteness, quirks and personality of your
                  foster will really help with their adoption. We use all of the
                  cute photos and videos to post on their Pet Rescue page to
                  help them find their forever home. The more content you have,
                  the better! Pictures of them sleeping, playing, in their
            ...
            We are always seeking valuable foster carers to provide care to our buns. Once your bun has been adopted, please let us know if you would, consider taking on another bun as a foster, if you need a little bit of a pause inbetween or if you think this was a one-off thing. No matter how long of a break you take we will always be happy to welcome you back.
            `}
                </p>
                ...
                <p className="text-md whitespace-pre-line font-light lg:pr-0 xl:mb-6 xl:text-xl">
                  If you do fall completely in love with one of your foster buns
        ...
        c-1.649-0.359-3.438-0.03-4.892,1.065l-9.35,7.047C308.011,323.877,307.483,327.639,309.478,330.285z"
          ...
          <FosterParagraph
            ...
            body={
              <p className="text-md whitespace-pre-line font-light lg:pr-0 xl:mb-6 xl:text-xl">
                ...
                to showcase as many of the buns we have in our care as possible,
                ...
                location and will let you know if we would really like the bun
                you are caring for to be in attendance. It would be great if you
                could drop the rabbit off at the event on the day, and pick it
                up if the bunny unfortunately hasn’t been adopted. In some
                cases, we have Adoption Coordinators travelling past your area
                and they may be able to collect and drop off the rabbit one way
                or both. Either way, please let us know which suits and we will
          ...
          <FosterParagraph
            ...
            body={
              <>
                <p className="text-md whitespace-pre-line font-light lg:pr-0 xl:mb-6 xl:text-xl">
                  {`Strong Hearts have a pre-approved list of vet clinics that provide care to our bunnies. If you have reported an illness or concern about one of the buns in your care, Strong Hearts will arrange to book an appointment with one of our partnered vet clinics. While you think you are trying to be helpful, we ask that you please do not book the rabbit in to your local vet, or try to book the rabbit into one of our pre-approved vets yourself.
          ...
          <FosterParagraph
            ...
            body={
              <p className="text-md whitespace-pre-line font-light lg:pr-0 xl:mb-6 xl:text-xl">
                ...
                our best to re-home the rabbit as soon as possible but please be
  ...
  s5.119-0.976,7.071-2.929l6.974-6.974c3.905-3.905,3.905-10.237,0-14.143C281.156,197.035,274.824,197.035,270.918,200.94z"
      ...
      bottomImages={{
        first: rabbitFoster1,
        firstAlt:
          "big fluffy brown rabbit looking at the camera while hugging their foster carer",
        second: rabbitFoster2,
        secondAlt:
          "a black fluffy rabbit sittingnext to it's brown rabbit best friend in their adopted home",
        third: rabbitFoster3,
        thirdAlt: "a small black rabbit nibbling at a big red strawberry",
      }}
    />
  );
}
