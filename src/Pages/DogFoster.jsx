...
import foster1 from "../assets/dog-foster-photos/dog-foster-1.jpg";
import foster2 from "../assets/dog-foster-photos/dog-foster-2.jpg";
import foster3 from "../assets/dog-foster-photos/dog-foster-3.jpg";

export default function DogFoster() {
  ...
  return (
    <FosterPageBody
      mainBlurb={`Fostering a dog is a rewarding experience that takes dedication and love. Our foster carers receive plenty of support and advice as they join our great community striving for the same goal. No prior experience is needed to become a foster carer, just a home and love to give. Join us today!`}
      applicationLink={"https://form.jotform.com/222302488264858"}
      onboardingLink={""}
      mainImage={dogFosterImage}
      mainImageAlt={""}
      infoBody={
        <>
          <FosterParagraph
            heading={"What you will need"}
            body={`Here are a list of supplies you will may need organised at your home prior to your foster dog's arrival:
          
          - Food bowls
          - Toys
          - Bedding
          - Animal crate / play-pen (this can be supplied if your foster requires one)
          
          All food during your foster journey will be provided.`}
            iconSvg={
              <svg
                fill="#3b485c"
                height="100%"
          ...
          <FosterParagraph
            heading={"What if you have a dog at home?"}
            body={
              <p>
                When fostering a dog, it’s essential to consider your resident
                canine companion. Their well-being matters as much as that of
                our rescue dogs. As such, it is important to ensure your
                resident dog is up-to-date on vaccinations. Regular shots
                protect against common diseases and create a barrier against
                potential illnesses brought in by foster dogs. Our foster dogs
                often come from pounds or uncertain backgrounds. While we strive
                to provide a clean slate, there’s always a risk of introducing
                infections. Vigilance is key. Remember, a healthy resident dog
                sets the stage for a successful foster experience. By
                safeguarding their health, you’re not only protecting them but
                also ensuring a harmonious home for all.
              </p>
            }
            iconSvg={
              <svg
          ...
          <FosterParagraph
            ...
            body={
              <p className="text-md  whitespace-pre-line  font-light lg:pr-0 xl:mb-6 xl:text-xl">
                Upon the arrival of your first foster dog, you will be invited
                ...
                pictures of your dogs with the rest of the group and provide
            ...
            body={
              <>
                <p className="text-md  whitespace-pre-line  font-light lg:pr-0 xl:mb-6 xl:text-xl">
                  ...
                  update on your foster dog. Ideally, this includes an updated
                  picture and written update on how the dog is going in your
                ...
                <p>
                  {" "}
                  The weekly check-in isn’t only for the dog's welfare, it is
                  also a welfare check on you! Sometimes foster caring can be
                  tough, we know that. You can try and try and a dog can just
                  ...
                  dog. If you forget to reach out to us at least once per week,
          ...
          <FosterParagraph
            ...
            body={
              <div className="flex flex-col gap-2 pl-2 md:pl-8 [&>h1]:font-semibold">
                ...
                <p className="text-md font-light lg:pr-0 xl:mb-6 xl:text-xl">
                  While the dog is in your care, we ask that you keep us updated
                  with regular pictures and videos. Look for photo opportunities
                  when possible. A good photo is the difference between a puppy
                  or dog staying in care for weeks. Photos with good lighting
            ...
            We are always seeking valuable foster carers to provide care to our dogs. Once your dog has been adopted, please let us know if you would, consider taking on another dog as a foster, if you need a little bit of a pause inbetween or if you think this was a one-off thing. No matter how long of a break you take we will always be happy to welcome you back.
            `}
                </p>
                ...
                <p className="text-md whitespace-pre-line font-light lg:pr-0 xl:mb-6 xl:text-xl">
                  If you do fall completely in love with one of your foster dogs
        ...
        c-1.649-0.359-3.438-0.03-4.892,1.065l-9.35,7.047C308.011,323.877,307.483,327.639,309.478,330.285z"
          ...
          <FosterParagraph
            ...
            body={
              <p className="text-md whitespace-pre-line font-light lg:pr-0 xl:mb-6 xl:text-xl">
                ...
                to showcase as many of the dogs we have in our care as possible,
                ...
                location and will let you know if we would really like the dog
                you are caring for to be in attendance. It would be great if you
                could come to the day with your foster dog and accompany them in
                their search for their forever home.
              </p>
            }
            iconSvg={
              <svg
          ...
          <FosterParagraph
            ...
            body={
              <>
                <p className="text-md whitespace-pre-line font-light lg:pr-0 xl:mb-6 xl:text-xl">
                  {`Strong Hearts have a pre-approved list of vet clinics that provide care to our dogs. If you have reported an illness or concern about one of the dogs in your care, Strong Hearts will arrange to book an appointment with one of our partnered vet clinics. While you may think you are trying to be helpful, we ask that you please do not book the dog in to your local vet, or try to book the dog into one of our pre-approved vets yourself.
          ...
          <FosterParagraph
            ...
            body={
              <p className="text-md whitespace-pre-line font-light lg:pr-0 xl:mb-6 xl:text-xl">
                ...
                our best to re-home the dog as soon as possible but please be
  ...
  s5.119-0.976,7.071-2.929l6.974-6.974c3.905-3.905,3.905-10.237,0-14.143C281.156,197.035,274.824,197.035,270.918,200.94z"
      ...
      bottomImages={{
        first: foster1,
        firstAlt:
          "big brown and white dog sleeping on the couch with their  foster carer",
        second: foster2,
        secondAlt:
          "a big brown dog with its eyes closed being hug by their foster carer",
        third: foster3,
        thirdAlt: "a white puppy playing with a small child",
      }}
    />
  );
}
