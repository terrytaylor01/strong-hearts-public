...
import bunAdoptImage from "../assets/bun-foster-picture.jpg";
const AdoptCarousel = React.lazy(() => import("../components/AdoptCarousel"));

export default function BunAdopt() {
        ...
        <div className="mt-12 flex w-[100vw] flex-col  items-center justify-center gap-12 py-2 text-skin-textprimary md:mt-28 md:flex-row">
          <div className="mt-2 flex flex-col gap-6 pl-10 sm:mt-2 sm:w-fit sm:px-8 md:pl-28">
            ...
            <span className="flex flex-col justify-center gap-4 md:flex-row md:justify-normal [&>a]:w-fit">
              <a
                href="https://form.jotform.com/220056278557864"
                target="_blank"
      ...
      <div className="bg-skin-bgsecondary pb-10">
        ...
        {/* <div className="mb-12 flex flex-col items-center justify-center gap-12 font-inter lg:flex-row lg:gap-32">
          <div className="mx-8  flex aspect-[650/400] overflow-clip rounded-3xl bg-white shadow-lg md:w-[650px]">
            <img src={sampleCat} className="h-[100%] w-[40%] object-cover" />
      ...
      >
        ...
        <div className="mt-2 flex flex-col gap-2 pl-10 text-skin-textprimary sm:mt-2 sm:px-8 md:w-[80vw] xl:pl-0">
          ...
          <p className="text-md whitespace-pre-line pr-10 font-light lg:pr-0 xl:mb-6  xl:text-xl ">
            {`When it comes to selecting a rabbit, take your time to carefully think about what type of rabbit you are after, and what type of pet is right for you and your household. Please be sure to discuss this decision with your whole household. 

            Adopting and owning a rabbit is a wonderful experience. It is also extra special to adopt a rabbit from us as we specialise in the rescue of kill-listed animals who are facing certain euthanasia if they aren't taken by us. You really are giving a rabbit a second chance at life!
            Rabbits are such beautiful companions.

            It is important to remember that while rabbits are fairly low-maintenance, they do require proper care throughout their entire life. So before applying to adopt, be sure you have really thought through what this may entail and whether you are prepared for the responsibility of owning a rabbit.
            
            At Strong Hearts, we see a whole range of temperaments and personalities in our rabbits. We rescue rabbits of all ages, from teeny tiny babies to seniors. We describe each rabbit's personality in their Pet Rescue profiles, but feel free to ask us any further questions!
            `}
          </p>
        </div>
        <div className="mt-2 flex flex-col gap-2 pl-10 text-skin-textprimary sm:mt-2 sm:px-8 md:w-[80vw] xl:pl-0">
          <h1 className="text-2xl text-[2rem] xl:text-3xl">
            Applying for a rabbit
          </h1>
          <p className="text-md whitespace-pre-line pr-10 font-light lg:pr-0 xl:mb-6 xl:text-xl">
            ...
            Our adoption co-ordinators review every application that comes through as promptly as possible. If we feel your household is suitable for the particular rabbit that you are enquiring about, we will call you for a phone interview to ensure that the best possible match has been made. If we believe the rabbit you've enquired about isn't going to be the best fit for your household, we will give you a call to discuss if there is some other rabbit that may be better suited.
        ...
        <div className="mt-2 flex flex-col gap-2 pl-10 text-skin-textprimary sm:mt-2 sm:px-8 md:w-[80vw] xl:pl-0">
          ...
          <p className="text-md whitespace-pre-line pr-10 font-light lg:pr-0 xl:mb-6 xl:text-xl">
            {`The third and final step before officially adopting a rabbit is a Meet & Greet. It is a Strong Heart policy to arrange a Meet & Greet with the prospective family and the rabbit before finalising the adoption. The adoption co-ordinator for the rabbit you've expressed interest in will arrange a time with the rabbit's foster carer for the Meet & Greet. The Meet & Greet will be hosted at the foster carers house. 
            
            On the day, you will visit the foster carers home. Don’t worry, they are lovely – we promise! They will let you have a pat and a play with the rabbit. The foster carer will tell you a bit about the rabbit's personality and what they have been like for the time they’ve been in their care.
            
            We encourage prospective parents to spend some time around the rabbit (around about half an hour) and see if the vibe works. Chat to the foster carer about what the rabbit has been eating when staying with them, what kind of food they like, if they has a preferred bedding, favourite toys etc. Basically, any question you have about the rabbit, ask away! If there’s a question they can’t answer, feel free to follow up with your adoption co-ordinator.
            If you would like to adopt on the day of the Meet & Greet, and take the rabbit home with you, this can be discussed with your adoption coordinator.
            
            Please note, that to be eligible for adoption it is a Strong Hearts' requirement that rabbits are desexed and microchipped.
            `}
          </p>
        </div>
        <div className="mt-2 flex flex-col gap-2 pl-10 text-skin-textprimary sm:mt-2 sm:px-8 md:w-[80vw] xl:pl-0">
          <h1 className="text-2xl text-[2rem] xl:text-3xl">
            Strong Hearts Bun Rescue Adoption Policies
          </h1>
          <p className="text-md whitespace-pre-line pr-10 font-light lg:pr-0 xl:mb-6 xl:text-xl">
